			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Cambia Password</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" method="post" action="update_password.php">
							<fieldset>
							  ...
							  <div class="form-actions">
								<button type="submit" onclick="return confirmUpdateAdmin()" class="btn btn-primary">Salva Cambiamenti</button>
							  </div>
							</fieldset>
						</form>
