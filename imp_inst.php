						...
						<form class="form-horizontal" method="post" action="save_imp.php" onSubmit="return controlloForm(this)">
							<fieldset>
                              ...
                              <label class="control-label" for="focusedInput">Username:</label>
								<div class="controls">
								  <select class="input-xlarge focused" name="txtusername" id="focusedInput">
                                  <?php
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="txtdenominazione" id="focusedInput" type="text" placeholder="Link">
								</div>
							  </div>
